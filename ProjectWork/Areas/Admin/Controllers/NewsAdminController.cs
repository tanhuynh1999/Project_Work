...
namespace ProjectWork.Areas.Admin.Controllers
{
    public class NewsAdminController : Controller
    {
        ...
        {
            return View(db.News.OrderByDescending(t => t.news_datepost).ToPagedList(page ?? 1, PAGE_SIZE));
        }
        ...
        public ActionResult Create([Bind(Include = "news_id,news_title,news_image,news_contents,news_tags,news_datepost,news_views")] News news)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "news_id,news_title,news_image,news_contents,news_tags,news_datepost,news_views")] News news)
        {
            if (ModelState.IsValid)
            {
