...
namespace ProjectWork.Controllers
{
    public class CvsController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Create([Bind(Include = "cv_id,cv_fullname,cv_location,cv_birth,cv_phone,cv_email,cv_addpress,cv_website,cv_target,cv_interests,cv_information,cv_title,cv_img,theme_id,sex_id,user_id,cv_education,cv_graduation,cv_jobexperience,cv_datejobexperience,cv_outdooractivities,cv_dateoutdooractivities,cv_certificate,cv_datecertificate, cv_prize, cv_dateprize, cv_skill, cv_dateskill")] Cv cv, HttpPostedFileBase cv_img, List<String> Education, List<DateTime> GraduationDate, List<String> JobExperience, List<DateTime> DateJobExperience, List<String> OutdoorActivities, List<DateTime> DateOutdoorActivities, List<String> Certificate, List<DateTime> DateCertificate, List<String> Prize, List<DateTime> DatePrize, List<String> Skill, List<DateTime> DateSkill)
        {
